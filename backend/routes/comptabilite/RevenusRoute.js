...
import {AjouterR,ModifierR,ListeR,ArchiverR} from '../../controllers/comptabilite/RevenusControl.js'
...
const storage = multer.diskStorage({
    destination: function (req, file, cb) {
        ...
        const dir = path.join(__dirname, `../../public/revenus/${code}`);
...
router.post('/ajouter',upload.single('fichier'),AjouterR);
router.get('/liste',ListeR);
// router.get('/typeRevenue/:id',FindR);
router.put('/modifier/:id',upload.single('fichier'),ModifierR);
router.patch('/archiver/:id', ArchiverR);
