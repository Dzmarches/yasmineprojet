...
import { getEmploiDuTempsBySection,getMatieresByNiveau,updateDureeMatiere,getPeriodes,savePeriodes,
    genererEmploiAuto, getEmploiDuTempsEnseignant
...
router.get('/periodes/:cycleId', getPeriodes);
...
router.get('/enseignant/:enseignantId', getEmploiDuTempsEnseignant);
