...
const GestionAcademiqueAutres = () => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:5000/categorie', {
                ...
                params: {
                    magasin: 'pédagogique' // Ajout du paramètre magasin
                }
            });
        ...
        try {
            if (isEdit) {
                ...
                await axios.post('http://localhost:5000/categorie/save', {
                    ...values,
                    magasin: values.magasin || 'pédagogique', // Ajout du champ magasin
    ...
    const fetchAchats = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:5000/achat', {
                ...
                params: {
                    magasin: 'pédagogique' // ✅ Ajout du paramètre
                }
            });
    ...
    const fetchFournisseurs = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:5000/fournisseur', {
                ...
                params: {
                    magasin: 'pédagogique' // Filtrage par magasin
                }
            });
    ...
    const handleEditsortie = (sortie) => {
        setValues({
            ...
            magasin: sortie.article?.magasin || 'pédagogique' // dépend si tu récupères `article.magasin`
        });
                                            ...
                                            <div className="form-group" style={{ flex: 1 }}>
                                                <Select
                                                    ...
                                                    options={fournisseurs
                                                        .filter(f => f.magasin === 'pédagogique') // Filtrage supplémentaire si nécessaire
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <div className="form-group" style={{ display: 'none' }}>
                                                <select
                                                    name="magasin"
                                                    className="form-control input"
                                                    value={values.magasin || 'pédagogique'}
