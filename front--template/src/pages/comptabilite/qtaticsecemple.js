                ...
                <div className="revenue-breakdown">
                  ...
                  <div className="revenue-item d-flex justify-content-between align-items-center mb-2 py-2">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <span className="text-muted small">Revenu Paiement Élèves:</span>
            ...
            <Card className="border-start border-success border-3 shadow-sm h-100 hover-effect">
              <Card.Body className="py-3">
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <h5 className="text-muted mb-0 ms-3 ml-2">Total  Paiements Élèves </h5>
                </div>
                {/* Montant principal */}
                <h2 className="text-success mb-3">
                  {stats.totalRevenu.toLocaleString('fr-FR')} <small className="fs-6">DZD</small>
                ...
                <div className="revenue-breakdown">
                  ...
                  <div className="revenue-item d-flex justify-content-between align-items-center mb-2 py-2">
                    <div className="d-flex align-items-center">
                      <div className="dot-indicator bg-success me-2"></div>
                      <div>
                        <span className="text-muted small">Paiements Élèves (Effectués)</span>
                        <div className="fw-semibold">660,000 DZD</div>
                      </div>
                    </div>
                    <div className="percentage-value text-success">
            ...
            <Card className="border-start border-success border-3 shadow-sm h-100 hover-effect">
              <Card.Body className="py-3">
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  <h5 className="text-muted mb-0 ms-3 ml-2">Paiements Élèves (Non payé)</h5>
                </div>
                {/* Montant principal */}
                <h2 className="text-danger mb-3">
                  {stats.totalRevenu.toLocaleString('fr-FR')} <small className="fs-6">DZD</small>
                ...
                <Row>
                  <Col md={6}>
                    <Table striped hover responsive>
                      ...
                      <tbody>
                        {stats.depensesParCategorie.map((item, index) => (
                          <tr key={index}>
                  ...
                  <Col md={6}>
                    <div className="text-center">
                      <PieChart size={150} className="text-muted mb-2" />
                      <p className="text-muted">Répartition des Dépenses</p>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
