...
const ArchiveRH = () => {
    ...
    const modules = [
        ...
        { to: 'pointages', title: 'Pointages', permission: 'Ressources Humaines-Gestion pointage-Voir' },
        { to: 'poste', title: 'Postes', permission: 'Ressources Humaines-Gestion des employées-Voir' },
        { to: 'service', title: 'Services', permission: 'Ressources Humaines-Gestion des employées-Voir' },
        { to: 'primes', title: 'Primes', permission: 'Ressources Humaines-gestion de la paye-Voir' },
        { to: 'periodePaie', title: 'Périodes de paie', permission: 'Ressources Humaines-gestion de la paye-Voir' },
        { to: 'journalpaie', title: 'Journal de paie', permission: 'Ressources Humaines-Gestion demande de congé-Voir' },
        { to: 'parametreRetard', title: 'Paramétre des retards', permission: 'Ressources Humaines-gestion de la paye-Voir' },
        { to: 'heureSup', title: 'Heures supplémentaires', permission: 'Ressources Humaines-gestion de la paye-Voir' },
    ]
    ...
    return (
        <div>
            <nav className="mt-5">
                ...
                <span> / </span>
                <span>les archives du module RH </span>
            </nav>
