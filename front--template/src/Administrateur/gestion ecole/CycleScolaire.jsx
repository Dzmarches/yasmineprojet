...
import '../../pages/Academiques/modal.css';
...
const CycleScolaire = () => {
        ...
        try {
            ...
            if (selectedCycle) {
                const response = await axios.put(
                    `http://localhost:5000/cyclescolaires/${selectedCycle.id}`,
                    {
                        classement,
                        nomCycle,
                        nomCycleArabe,
                ...
                const response = await axios.post(
                    'http://localhost:5000/cyclescolaires',
                    {
                        classement,
                        nomCycle,
                        nomCycleArabe,
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await axios.delete(`http://localhost:5000/cyclescolaires/${id}`, config);
